   ...
   <center>
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
					...
					<td><input type="password" name="confirmPassword"
						placeholder="Confirm Password is required" size="23"
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" placeholder="Greater than 18 year" size= "23" readonly="readonly" id="datepicker" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <%--   <tr>
                    ...
                    <td><input type="text" name="mobileno" maxlength="10" placeholder="Enter Mobile No" size= "23" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
